...
export type User = {
  ...
  buyingConditionChanges?: Maybe<Array<BuyingConditionChange>>;
  createdNfts?: Maybe<Array<Nft>>;
  /** Nfts which this user has created that have been redeemed */
  creatorRedemptions?: Maybe<Array<Redeem>>;
  id: Scalars['ID'];
  incomingTransfers?: Maybe<Array<Transfer>>;
  outgoingTransfers?: Maybe<Array<Transfer>>;
  ownedNfts?: Maybe<Array<Nft>>;
  purchases?: Maybe<Array<Sale>>;
  /** Nfts which this user has redeemed */
  redemptions?: Maybe<Array<Redeem>>;
  royaltiesAccrued?: Maybe<Array<Sale>>;
...
export type NftFieldsFragment = { __typename?: 'Nft', id: string, tokenId: any, tokenURI: string, contractAddress: string, name: string, description: string, work: string, availabilityTo: any, availabilityFrom: any, allowedBuyer: string, duration: any, forSale: boolean, redeemed: boolean, royaltyBasisPoints: any, price: any, mintTimestamp: number, lastPurchaseTimestamp: number, owner: { __typename?: 'User', id: string }, creator: { __typename?: 'User', id: string }, royaltyReceiver: { __typename?: 'User', id: string }, currency: { __typename?: 'PaymentToken', id: string, decimals: number, acceptable: boolean, symbol: string } };
...
export type NftsQuery = { __typename?: 'Query', nfts: Array<{ __typename?: 'Nft', id: string, tokenId: any, tokenURI: string, contractAddress: string, name: string, description: string, work: string, availabilityTo: any, availabilityFrom: any, allowedBuyer: string, duration: any, forSale: boolean, redeemed: boolean, royaltyBasisPoints: any, price: any, mintTimestamp: number, lastPurchaseTimestamp: number, owner: { __typename?: 'User', id: string }, creator: { __typename?: 'User', id: string }, royaltyReceiver: { __typename?: 'User', id: string }, currency: { __typename?: 'PaymentToken', id: string, decimals: number, acceptable: boolean, symbol: string } }> };
...
export type SalesQuery = { __typename?: 'Query', sales: Array<{ __typename?: 'Sale', id: string, timestamp: any, price: any, royaltyReceiver: { __typename?: 'User', id: string }, currency: { __typename?: 'PaymentToken', id: string, decimals: number, acceptable: boolean, symbol: string }, nft: { __typename?: 'Nft', id: string, tokenId: any, tokenURI: string, contractAddress: string, name: string, description: string, work: string, availabilityTo: any, availabilityFrom: any, allowedBuyer: string, duration: any, forSale: boolean, redeemed: boolean, royaltyBasisPoints: any, price: any, mintTimestamp: number, lastPurchaseTimestamp: number, owner: { __typename?: 'User', id: string }, creator: { __typename?: 'User', id: string }, royaltyReceiver: { __typename?: 'User', id: string }, currency: { __typename?: 'PaymentToken', id: string, decimals: number, acceptable: boolean, symbol: string } } }> };
