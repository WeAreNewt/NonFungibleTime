...
export type NftFieldsFragment = { __typename?: 'Nft', id: string, tokenId: any, tokenURI: string, contractAddress: string, availabilityFrom: any, availabilityTo: any };

export type NftsQueryVariables = Exact<{ [key: string]: never; }>;


export type NftsQuery = { __typename?: 'Query', nfts: Array<{ __typename?: 'Nft', id: string, tokenId: any, tokenURI: string, contractAddress: string, availabilityFrom: any, availabilityTo: any }> };
