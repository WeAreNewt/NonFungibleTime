...
contract SvgGenerator is ISvgGenerator {
    ...
    function _getLastPart(
        ...
        return
            abi.encodePacked(
                ...
                _getCircle3(_isPair(availabilityTo + tokenId)),
                _getCircle4(_isPair(duration + tokenId)),
                _getCircle5(_isPair(uint160(minter) + tokenId)),
                _getCircle6(_isPair(tokenId)),
                _getNewt(redeemed)
            );
    }
    ...
    function _getCircle3(bool useFirstVariation) internal pure returns (string memory) {
        return
            useFirstVariation
    ...
    function _getCircle4(bool useFirstVariation) internal pure returns (string memory) {
        return
            useFirstVariation
    ...
    function _getCircle5(bool useFirstVariation) internal pure returns (string memory) {
        return
            useFirstVariation
    ...
    function _getCircle6(bool useFirstVariation) internal pure returns (string memory) {
        return
            useFirstVariation
    ...
    function _getNewt(bool useClosedEyesVariation) internal pure returns (string memory) {
        return
    ...
    function _rotationClass(
        ...
        return
            abi.encodePacked(
                className,
                ' { animation: ',
                _intToRotationOrientation(rotationSpeed),
                Strings.toString(rotationSpeed),
                's linear infinite; transform-box: fill-box; transform-origin: center; } '
            );
    }

    function _intToRotationOrientation(uint256 value) internal pure returns (string memory) {
        return _isPair(value) ? 'clockwise-rotation' : 'counter-clockwise-rotation';
    }
